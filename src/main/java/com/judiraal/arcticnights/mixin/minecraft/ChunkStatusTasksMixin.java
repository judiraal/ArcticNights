...
public class ChunkStatusTasksMixin {
    ...
    private static boolean an$checkStructureGen(boolean original, @Local(argsOnly = true) ChunkAccess chunk, @Local(argsOnly = true) WorldGenContext worldGenContext) {
